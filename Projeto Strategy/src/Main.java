...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        carrinho.pagar(new MeioPagamentoCieloDebitoEstrategia("1234567123456786", "11122233344", "111", "07/24"));
        carrinho.pagar(new MeioPagamentoCieloCreditoEstrategia("1234567123456786", "11122233344", "111", "09/25"));
